    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            if ($user->role == 'admin') {
                ...
                $directUrl = 'http://localhost/swallab/Swallab/headpage/headpage.html';
                $redirectUrl = $request->input('redirectUrl');
                // dd($redirectUrl);
                // var_dump($redirectUrl);
                if ($redirectUrl == "http:\/\/localhost\/MySwallab\/public\/defaultRedirect") {
                    $redirectUrl = $directUrl;
                }
                // $redirectUrl = $request->redirectUrl;
                // return response()->json($request->input('redirectUrl'));
